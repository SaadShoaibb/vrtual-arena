    ...
    <>
      <div className="bg-black text-white">
        ...
        <div className="relative h-[60vh] overflow-hidden">
          ...
          <img
            src="/assets/experiences/ufo/ufo5.jpeg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-black rounded-xl overflow-hidden group">
                <div className="aspect-video relative overflow-hidden bg-gray-800">
                  <img 
                    src="/assets/experiences/vr360/vr360.jpeg" 
                    alt="VR 360" 
                    className="w-full h-full object-cover"
                  />
                </div>
              ...
              <div className="bg-black rounded-xl overflow-hidden group">
                <div className="aspect-video relative overflow-hidden bg-gray-800">
                  <img 
                    src="/assets/experiences/vrbattle/vrbattle.jpeg" 
                    alt="VR Battle" 
                    className="w-full h-full object-cover"
                  />
                </div>
              ...
              <div className="bg-black rounded-xl overflow-hidden group">
                <div className="aspect-video relative overflow-hidden bg-gray-800">
                  <img 
                    src="/assets/experiences/arena/arena.jpeg" 
                    alt="Free-roaming Arena" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="p-6">
