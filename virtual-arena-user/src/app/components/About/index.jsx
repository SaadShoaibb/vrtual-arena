            ...
            <div className='w-full mx-auto max-w-[1600px] border-b pt-[113px] pb-[100px] flex justify-between items-center px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-6'>
                <div className='grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-4'>
                    <div className='flex flex-col '>
                        <h1 className='text-gradiant text-[26px] font-semibold '>About Us </h1>
                        ...
                        <p className='text-xl text-white font-light mt-[22px]'>
                            Vrtual Arena brings you the next generation of virtual experiences—from interactive games to immersive digital events. We’re on a mission to blur the line between the real and virtual, making innovation accessible and exciting for everyone.
                        </p>
                        ...
                        <p className='text-xl text-white font-light'>
                            Founded with a passion for immersive tech, Vrtual Arena started as a dream to make VR more fun and interactive. Today, we deliver unforgettable digital adventures to thousands worldwide.
                        </p>
                        ...
                        <p className='text-xl text-white font-light'>
                            We aim to innovate virtual spaces that connect, inspire, and entertain—bringing cutting-edge VR to everyday users.
                        </p>
                        ...
                        <div className='flex items-center flex-col md:flex-row mt-[43px] gap-5 md:gap-[30px] '>
                            ...
                            <div className='flex flex-col'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <h1 className='text-xl text-white font-semibold'>4.8 Ratings</h1>
                                </div>
                                <p className='text-[12px] text-white font-light'>Trusted by over 11,000 customers</p>
                            </div>
                        </div>
                    </div>
