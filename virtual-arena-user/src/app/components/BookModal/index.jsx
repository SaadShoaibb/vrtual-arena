...
const BookModal = ({ locale = 'en' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1001] flex justify-center items-center">
      ...
      {/* Modal Content */}
      <div id="booking-modal-container" className="relative flex flex-col items-center max-h-[90vh] overflow-auto w-full max-w-[700px] rounded-2xl bg-gradient-to-tr from-[#926BB9] via-[#5A79FB] to-[#2FBCF7] pt-16 pb-20 md:pb-12 px-2 md:px-6">
        {/* Close Icons */}
        <div
