            ...
            <div id='footer' className={`w-full  h-full  bg-blackish `}>
                <div className='w-full mx-auto max-w-[1600px] border-y pt-[100px] pb-[88px]  flex justify-between flex-wrap gap-6   px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-6'>
                    <div>
                        ...
                        <p className='font-light text-white max-w-[358px] mb-7'>Bringing you closer to reality through unforgettable VR experiences.</p>
                    ...
                    <div className='text-white '>
                        ...
                        <h3 className='font-light text-white  mt-7 mb-5'>Home</h3>
                        <h3 className='font-light text-white  mb-5'>About Us</h3>
                        <h3 className='font-light text-white  mb-5'>Game</h3>
                        <h3 className='font-light text-white  mb-5'>Gallery</h3>
                        <h3 className='font-light text-white  mb-5'>FAQS</h3>
                    </div>
                    <div className='text-white '>
                        <h1 className='text-[22px] font-bold '>Useful Links</h1>
                        <h3 className='font-light text-white  mt-7 mb-5'>VRA Service</h3>
                        <h3 className='font-light text-white  mb-5'>Pricing Plans </h3>
                        <h3 className='font-light text-white  mb-5'>News & Articles </h3>
                        <h3 className='font-light text-white  mb-5'>Privacy Policy</h3>
                        <h3 className='font-light text-white  mb-5'>Terms & Conditions</h3>
                    </div>
                    <div className='text-white '>
                        <h1 className='text-[22px] font-bold '>Contact Us</h1>
                        <h3 className='font-light text-white  mt-7 mb-5 flex items-center gap-2 '><span><img src="/icons/phone.png" alt="" className='min-w-full min-h-full' /></span>+1 (763) 478-6014   +1 (800) 328-1466</h3>
                        <h3 className='font-light text-white  mb-5 flex items-center gap-2 '><span><img src="/icons/mail.png" alt="" className='min-w-full min-h-full' /></span>hello@vrtualarena.com </h3>
                        <h3 className='font-light text-white  mb-5 flex items-center gap-2 max-w-[347px] '><span><img src="/icons/location.png" alt="" className=' min-h-full h-4 min-w-3' /></span>Loram Maintenance of Way 3900 Arrowhead Dr.
                            | P.O. Box 188 | Hamel, MN 55340. </h3>
                    </div>
                </div>
            </div>
            <p className='py-[22px] text-center bg-blackish w-full text-lg font-light text-white'>Copyright © 2024 Vrtual Arena All Rights Reserved.</p>
        </>
    )
}
